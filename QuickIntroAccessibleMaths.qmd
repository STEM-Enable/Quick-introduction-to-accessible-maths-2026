...
- Graphical elements
  -   [Desmos was designed to work and tested with screenreaders and written to conform to WCAG 2.2](https://www.desmos.com/accessibility)
  ...
  -   [Complex images - making sense for accessibility](https://www.learningapps.co.uk/moodle/xertetoolkits/play.php?template_id=3023#page1)
  -   [DIAGRAM Center](http://diagramcenter.org/) has some great resources for those new to diagram description:
      -   Poet Image Description Training Tool, Image description guidelines and Sample book
