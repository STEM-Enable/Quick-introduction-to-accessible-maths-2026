...
- [Transform Word to other formats](https://www.cwu.edu/student-life/student-support/central-access/resources/reader.php)
...
-   Attempt to transform the LaTeX to HTML with MathJax using [Chirun](https://chirun.org.uk/) or [lwarp](https://ctan.org/pkg/lwarp?lang=en)
...
-   Work in a Markdown format, using LaTeX for equations, with HTML has the primary output (can also output LaTeX/PDF); can create slides and single-source slides and documents (like Beamer)
    ...
    - [Clavertondown](https://bathmash.github.io/clavertondown/), built on top of RMarkdown and Bookdown; should only be used if the other formats can't meet needs
...
Want to see how I built this single-source, multiple-outputs document? [Github repository](https://github.com/STEM-Enable/Quick-introduction-to-accessible-maths-2026/)
